...
import com.gettasksdone.gettasksdone.databinding.FragmentCompletadasBinding
...
class CompletadasFragment : Fragment(), TaskCompletionListener {
    ...
    private lateinit var completadasViewModel: CompletadasViewModel
    ...
    override fun onCreateView(
        ...
        completadasViewModel = ViewModelProvider(this, factory).get(CompletadasViewModel::class.java)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        completadasViewModel.tasks.observe(viewLifecycleOwner) { tasks ->
            // Actualiza la interfaz de usuario con las tareas obtenidas
            // Configura el RecyclerView con un Adapter que muestra las tareas
            recyclerView.adapter = TaskAdapter(tasks, apiService, jwtHelper, this@CompletadasFragment, this)
        }
        // Llama al método para obtener las tareas
        completadasViewModel.getTasks()
    }
