...
import com.gettasksdone.gettasksdone.databinding.FragmentHomeBinding
...
private var _binding: FragmentHomeBinding? = null
  ...
  private val binding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        val         inboxViewModel = ViewModelProvider(this, InboxViewModelFactory(jwtHelper)).get(InboxViewModel::class.java)
